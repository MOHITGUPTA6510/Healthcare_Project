...
def appointment_update(request, pk):
    ...
    return render(request, 'appointments/appointment_form.html', {'form': form, 'title': 'Update Appointment', 'appointment': appointment})
...
def add_prescription(request, appointment_pk):
    ...
    return render(request, 'appointments/prescription_form.html', {'form': form, 'appointment': appointment})
...
def today_appointments(request):
    ...
    return render(request, 'appointments/today_appointments.html', {'appointments': appointments, 'today': today})
